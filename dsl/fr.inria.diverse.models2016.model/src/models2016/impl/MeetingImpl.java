 ...
 * </p>
 * <ul>
 *   <li>{@link models2016.impl.MeetingImpl#getParticipants <em>Participants</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeetingImpl extends EventImpl implements Meeting {
	...
	public EList<Person> getParticipants() {
		if (participants == null) {
			participants = new EObjectContainmentEList<Person>(Person.class, this, Models2016Package.MEETING__PARTICIPANTS);
		}
		return participants;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Models2016Package.MEETING__PARTICIPANTS:
