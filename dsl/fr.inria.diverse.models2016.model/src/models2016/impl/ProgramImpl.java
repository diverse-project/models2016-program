 ...
 * </p>
 * <ul>
 *   <li>{@link models2016.impl.ProgramImpl#getDays <em>Days</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return Models2016Package.Literals.PROGRAM;
	}
	...
	public EList<Day> getDays() {
		if (days == null) {
			days = new EObjectContainmentEList<Day>(Day.class, this, Models2016Package.PROGRAM__DAYS);
		}
		return days;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Models2016Package.PROGRAM__DAYS:
