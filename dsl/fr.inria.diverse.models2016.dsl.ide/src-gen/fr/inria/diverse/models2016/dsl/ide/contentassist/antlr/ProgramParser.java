		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConferenceAccess().getGroup_2(), "rule__Conference__Group_2__0");
					put(grammarAccess.getConferenceAccess().getGroup_3(), "rule__Conference__Group_3__0");
					put(grammarAccess.getConferenceAccess().getGroup_3_3(), "rule__Conference__Group_3_3__0");
					...
					put(grammarAccess.getConferenceAccess().getResourcesAssignment_2_1(), "rule__Conference__ResourcesAssignment_2_1");
					put(grammarAccess.getConferenceAccess().getResourcesAssignment_2_2(), "rule__Conference__ResourcesAssignment_2_2");
					put(grammarAccess.getConferenceAccess().getPapersAssignment_3_2(), "rule__Conference__PapersAssignment_3_2");
					put(grammarAccess.getConferenceAccess().getPapersAssignment_3_3_1(), "rule__Conference__PapersAssignment_3_3_1");
